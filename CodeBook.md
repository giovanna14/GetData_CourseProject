Tidy data from smartphone accelerometers
========================================
...
The data used for this project are taken from the web site of the Coursera course "Getting and Cleaning Data" at the following URL

https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip

The original data and detailed explanations on how they were
obtained are available in the web site

http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones

The data are the outcome of an experiment aimed at recognizing
human activities based on the measurements collected by the 
accelerometers and gyroscopes of Samsung Galaxy SII smartphones. 
For this experiment, a group of 30 volunteers weared the
smartphone on their waist while performing 6 types of activity.
...
to form a single data frame composed of the 3 columns

1 subject  
2 activityID  
3 activityName  

followed by the 561 columns of measurements with labels as listed
above.
